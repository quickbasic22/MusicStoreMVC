...
namespace MusicStoreMVC.Controllers
{
    public class ArtistsController : Controller
    {
        ...
        public ArtistsController(MusicStoreMVCContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Artist != null ? 
                          ...
                          Problem("Entity set 'MusicStoreMVCContext.Artist'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MusicStoreMVCContext.Artist'  is null.");
            }
            var artist = await _context.Artist.FindAsync(id);
            if (artist != null)
            {
